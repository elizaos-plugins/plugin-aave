...
export function getAaveAddresses(network: 'base' | 'base-sepolia') {
    return network === 'base' ? AAVE_V3_BASE_ADDRESSES : AAVE_V3_BASE_SEPOLIA_ADDRESSES;
}

/**
 * Create default Aave configuration
 */
export function createDefaultConfig(network: 'base' | 'base-sepolia', rpcUrl: string): AaveConfig {
