 ...
 */
export function parseToBigNumber(value: string, decimals: number = 18): BigNumber {
 ...
 */
export function getHealthFactorRiskLevel(healthFactor: number): 'CRITICAL' | 'WARNING' | 'SAFE' | 'VERY_SAFE' {
 ...
 */
export function estimateGasCost(gasLimit: BigNumber, gasPrice: BigNumber): BigNumber {
 ...
 */
export function isDustAmount(amount: BigNumber, decimals: number = 18): boolean {
